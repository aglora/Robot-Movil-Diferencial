...
{
public:
  void DebugValuesBluetooth(unsigned int Ref_Distancia, float d1, float d2, float distancia, float theta, unsigned char PWM_A, unsigned char PWM_B);
  void recibeDatosBluetooth(unsigned int *referencia, bool *powerON, Controlador &controlNear, Controlador &controlFar, Controlador &controlOrientacion, movimientoCoche &motorA, movimientoCoche &motorB);
};
