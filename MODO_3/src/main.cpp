...
void setup()
{
  ...
  //Medición inicial de referencia de distancia
  float medidas[5];
  for(int i=0;i<5;i++)
  {
    medidas[i] = (sonarA.tomaMedidaUltrasonidos()+sonarB.tomaMedidaUltrasonidos())/2;
    delay(60);
  }
